...
# Dashboard content with proper UTF-8 encoding
...
# Write with UTF-8 encoding, using binary mode to avoid any encoding issues
output_path = "../src/pages/Dashboard.tsx"
with io.open(output_path, "w", encoding="utf-8") as f:
    f.write(dashboard_code)

print("Dashboard fixed with UTF-8 encoding")
